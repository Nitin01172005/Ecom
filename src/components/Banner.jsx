...
const Banner = () => {
  return (
    <div className='min-h-[550px] flex justify-center items-center py-8 sm:py-0 dark:bg-gray-900 dark:text-white duration-200 relative z-40' >
      <div className='container'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center '>
          {/* image */}
          <div data-aos="zoom-in">
            <img className='max-w-[400px] h-[350px] w-full mx-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover' src={BannerImg} alt="banner" />
          </div>
          <div className='flex flex-col justify-center gap-6 sm:pt-0'>
            <h1 data-aos="fade-up" className='text-3xl sm:text-4xl font-bold'>Winter Sale Upto 50% Off</h1>
            <p className='text-sm text-gray-500 tracking-wide leading-5'>Huge clothing sale: trendy styles, massive discounts, limited time, shop now, refresh your wardrobe, unbeatable deals!</p>
